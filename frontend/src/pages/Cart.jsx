...
export default function Cart() {
  ...
  const handlePlaceOrder = async () => {
    ...
    setPlacing(true);
    try {
      const shippingAddress = { name: user.name, phone: '9999999999', street: '123 Main St', city: 'Bengaluru', state: 'Karnataka', pincode: '560001', country: 'India' };
    ...
    <main data-testid="cart-page" style={{ maxWidth: 1280, margin: '0 auto', padding: '32px 20px' }}>
      ...
      {items.length === 0 ? (
        <div style={{ textAlign: 'center', padding: '80px 20px' }}>
          ...
          <h3 style={{ fontSize: 20, color: 'var(--text-1)', marginBottom: 16 }}>Your cart is empty</h3>
