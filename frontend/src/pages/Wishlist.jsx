    ...
    <main data-testid="wishlist-page" style={{ maxWidth: 1280, margin: '0 auto', padding: '32px 20px' }}>
      ...
      {wishlist.length === 0 ? (
        <div style={{ textAlign: 'center', padding: '80px 20px' }}>
          ...
          <h3 style={{ fontSize: 20, color: 'var(--text-1)', marginBottom: 16 }}>Your wishlist is empty</h3>
          <Link to="/products" style={{ padding: '12px 28px', background: 'var(--fire)', color: '#fff', borderRadius: 'var(--r-full)', fontWeight: 600 }}>Browse Products</Link>
        </div>
      ) : (
